...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(); //Вызываем табы

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider ', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); //Пост запрос
...
var forms = function forms() {
  ...
  var message = {
    loading: 'Зашрузка...',
    success: 'Спасибо! Скоры мы с вами свяжимся',
